...
export default function Id() {
    ...
    return <div className="max-w-5xl m-auto">
        ...
        <Collapse className="mb-4">
            <Collapse.Panel header={recommendBook} itemKey="1">
                <p>CS APP</p>
            </Collapse.Panel>
        </Collapse>
        <Card>
